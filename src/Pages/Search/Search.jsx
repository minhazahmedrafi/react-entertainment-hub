  ...
  const fetchSearch = async() =>{
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/search/${type ? "tv" : "movie"}?api_key=8c1d0dd64996aeeb3b3d4cf89e302e71&language=en-US&query=${searchText}&page=${page}&include_adult=false`
      );
